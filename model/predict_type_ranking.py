...
from model.dataset import UniEDdataset, collate_fn_TC
...
if __name__ == "__main__":
    ...
    # predict_set = UniEDdataset(predict_samples, with_sent_tag=True)
    ...
    # predict_set = UniEDdataset(predict_samples, with_sent_tag=True, only_sen_w_events=True)
    # predict_samples = predict_set.data
    
    
    # predict based on results of trigger detector
    k=20
    with open('./exp/experiments_trigger_detector/wo_other_new_ontology/all_avg_128_bert_base_qa_linear_False/epoch_4/TD_results_test_annotated_no_other.json', 'r') as f:
